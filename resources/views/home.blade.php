...
<body id ="page-top">
    <div id="carouselExampleCaptions" class="carousel slide">
        ...
        <div class="carousel-item active">
                <img src="{{ asset('asset/img/home.png') }}" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <h5>Welcome to Silent Hill Pharmacy</h5>
                    <p>Feel Better, Live Better: Expert Pharmacy Care for Your Health Needs</p>
                </div>
            </div>
            <div class="carousel-item">
                <img src="{{ asset('asset/img/blackmores.jpg') }}" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <h5>Blackmores Bio C® 1000</h5>
            ...
            <div class="carousel-item">
                ...
                <div class="carousel-caption d-none d-md-block">
                    <h5>Panadol</h5>
                    <p>Redakan sakit flu dan batuk tidak berdahak</p>
                </div>
            </div>
        </div>
...
<div class="col">
    <div class="card h-100 text-center">
        ...
        <div class="card-body">
            ...
            <a href="#" class="btn btn-primary" style="background-color: #8cb27f; border-color: #8cb27f;">Rp 149.000</a>
        </div>
    </div>
</div>
        ...
        <div class="col">
            ...
            <img src="{{ asset('asset/img/card2.jpg') }}" class="card-img-top" alt="...">
                <div class="card-body">
                    ...
                    <a href="#" class="btn btn-primary"style="background-color: #8cb27f; border-color: #8cb27f;">Rp 5.000</a>
                </div>
            </div>
        </div>
        <!-- Kartu 3 -->
        <div class="col">
            ...
            <img src="{{ asset('asset/img/card3.jpg') }}" class="card-img-top" alt="...">
                <div class="card-body">
                    ...
                    <a href="#" class="btn btn-primary"style="background-color: #8cb27f; border-color: #8cb27f;">Rp 13.600</a>
                </div>
            </div>
        </div>
        <!-- Kartu 4 -->
        <div class="col">
            ...
            <img src="{{ asset('asset/img/card4.jpg') }}" class="card-img-top" alt="...">
                <div class="card-body">
                    ...
                    <a href="#" class="btn btn-primary"style="background-color: #8cb27f; border-color: #8cb27f;">Rp 8.000</a>
                </div>
            </div>
        </div>
        <!-- Kartu 5 -->
        <div class="col">
            ...
            <img src="{{ asset('asset/img/card5.jpg') }}" class="card-img-top" alt="...">
                <div class="card-body">
                    ...
                    <a href="#" class="btn btn-primary"style="background-color: #8cb27f; border-color: #8cb27f;">Rp 21.000</a>
                </div>
            </div>
        </div>
        <!-- Kartu 6 -->
        <div class="col">
            ...
            <img src="{{ asset('asset/img/card6.jpg') }}" class="card-img-top" alt="...">
                <div class="card-body">
                    ...
                    <a href="#" class="btn btn-primary"style="background-color: #8cb27f; border-color: #8cb27f;">Rp 209.000</a>
                </div>
            </div>
        </div>
        <!-- Kartu 7 -->
        <div class="col">
            ...
            <img src="{{ asset('asset/img/card7.jpg') }}" class="card-img-top" alt="...">
                <div class="card-body">
                    ...
                    <a href="#" class="btn btn-primary"style="background-color: #8cb27f; border-color: #8cb27f;">Rp 115.000</a>
                </div>
            </div>
        </div>
        <!-- Kartu 8 -->
        <div class="col">
            ...
            <img src="{{ asset('asset/img/card8.jpg') }}" class="card-img-top" alt="...">
                <div class="card-body">
                    ...
                    <a href="#" class="btn btn-primary"style="background-color: #8cb27f; border-color: #8cb27f;">Rp 47.000</a>
                </div>
            </div>
        </div>
        <!-- Kartu 9 -->
        <div class="col">
            ...
            <img src="{{ asset('asset/img/card9.jpg') }}" class="card-img-top" alt="...">
                <div class="card-body">
                    ...
                    <a href="#" class="btn btn-primary"style="background-color: #8cb27f; border-color: #8cb27f;">Rp 270.000</a>
                </div>
            </div>
        </div>
        <!-- Kartu 10 -->
        <div class="col">
            ...
            <img src="{{ asset('asset/img/card10.png') }}" class="card-img-top" alt="...">
                <div class="card-body">
                    ...
                    <a href="#" class="btn btn-primary"style="background-color: #8cb27f; border-color: #8cb27f;">Rp 180.000</a>
                </div>
            </div>
        </div>
        <!-- Kartu 11 -->
        <div class="col">
            ...
            <img src="{{ asset('asset/img/card11.jpg') }}" class="card-img-top" alt="...">
                <div class="card-body">
                    ...
                    <a href="#" class="btn btn-primary"style="background-color: #8cb27f; border-color: #8cb27f;">Rp 7.500</a>
                </div>
            </div>
        </div>
        <!-- Kartu 12 -->
        <div class="col">
            ...
            <img src="{{ asset('asset/img/card12.jpg') }}" class="card-img-top" alt="...">
                <div class="card-body">
                    ...
                    <a href="#" class="btn btn-primary"style="background-color: #8cb27f; border-color: #8cb27f;">Rp 13.000</a>
                </div>
            </div>
        </div>
    </div>
